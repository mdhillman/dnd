...
class Media {
    ...
    update(
        ...
        // CHANGE 1: Reduced wobble speed from 0.04 to 0.01
...
class App {
    ...
    boundOnResize!: () => void;
    // CHANGE 2: Removed boundOnWheel property
    ...
    // CHANGE 2: Removed onWheel method entirely
    ...
    addEventListeners() {
        ...
        // CHANGE 2: Removed boundOnWheel binding
        this.boundOnTouchDown = this.onTouchDown.bind(this);
        this.boundOnTouchMove = this.onTouchMove.bind(this);
        this.boundOnTouchUp = this.onTouchUp.bind(this);
        window.addEventListener("resize", this.boundOnResize);
        // CHANGE 2: Removed mousewheel and wheel listeners
    ...
    destroy() {
        ...
        // CHANGE 2: Removed mousewheel and wheel listeners cleanup
